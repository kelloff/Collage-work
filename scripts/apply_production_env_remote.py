...
PRODUCTION_LINES = {
    ...
    # Refill: только 0.5b (фон). 3b — для /generate_tasks* (новая игра).
    "OLLAMA_REFILL_MODEL": "qwen2.5:0.5b",
    "OLLAMA_REFILL_HEAVY_MODEL": "qwen2.5:3b",
    "OLLAMA_REFILL_HEAVY_FROM_LEVEL": "99",
    # Фон: 0.5b lvl 0–1 свободно; lvl 2–3 — vary шаблонов каталога; иначе каталог.
    "OLLAMA_REFILL_OLLAMA_MAX_LEVEL": "1",
    ...
    "OLLAMA_POOL_MODEL": "qwen2.5:0.5b",
    "OLLAMA_POOL_NUM_PREDICT": "0",
    "OLLAMA_POOL_MIN_PREDICT": "120",
    "OLLAMA_POOL_PREDICT_PER_TASK": "70",
    "OLLAMA_POOL_TEMPERATURE": "0.15",
    "OLLAMA_POOL_SINGLE_TIMEOUT": "180",
    "OLLAMA_POOL_NUM_CTX": "1024",
    "TASK_POOL_REFILL_MAX_OLLAMA_ATTEMPTS": "3",
    "TASK_POOL_REFILL_PAUSE_SEC": "1",
    "TASK_POOL_REFILL_ZERO_ADDED_WAIT": "5",
    ...
    "TASK_POOL_REFILL_RETRY_SEC": "8",
    "TASK_POOL_FAST_EMPTY_RETRY": "1",
    "TASK_POOL_BULK_CATALOG_SEED": "1",
    "TASK_POOL_SEED_CATALOG": "1",
    "TASK_POOL_RELAX_BELOW_TOTAL": "300",
...
def main() -> int:
    ...
    client.close()
    print("\nProduction .env applied (refill chunk=4, relaxed filters while pool < 300).")
    if clear_pool:
