...
@onready var volume_slider: HSlider = $MenuPanel/VBoxContainer/HSlider
@onready var resolution_box: OptionButton = $MenuPanel/VBoxContainer/OptionButton
...
func _style_ui() -> void:
	...
	if title:
		title.label_settings = GameUiTheme.make_subtitle_settings(28, GameUiTheme.C_TITLE)
